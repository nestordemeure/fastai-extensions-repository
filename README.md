...
- **FastHug** ([repo-V2](https://github.com/morganmcg1/fasthugs) / [discussion](https://forums.fast.ai/t/fasthugs-fastai-v2-and-huggingface-transformers/)) ese fastai-v2 with HuggingFace's pretrained transformers
