...
- **Batch size finder** ([repo-V1](https://github.com/DanyWind/fastai_bs_finder) / [repo-V2](https://github.com/hal-314/fastai-batch-size-finder) / [discussion](https://forums.fast.ai/t/batch-size-finder-from-openai-implemented-using-fastai/57620)) batch size finder from OpenAI
